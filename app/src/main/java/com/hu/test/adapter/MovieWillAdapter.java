 ...
 */
public class MovieWillAdapter extends BaseQuickAdapter<Movie250Modle.SubjectsBean> {

    private Context mContext;
    private SimpleDraweeView simpleDraweeView;

    public MovieWillAdapter(Context context, List<Movie250Modle.SubjectsBean> data) {
